  ...
  return (
    <div className="min-h-screen bg-gray-100 text-[#065f46] font-sans">
      ...
      <div className="w-full mx-auto flex flex-col md:flex-row gap-8 ">
        <section className="flex flex-col md:flex-row items-center bg-green-600 p-10 mt-20 shadow-lg gap-10">
          <div className="md:w-1/2">
            <h2 className="text-4xl font-medium text-white mb-8 text-right ">..وجهة نظرنا</h2>
            <p className="text-lg text-white  text-right">
             هي منصة أردنية وُلِدت من الكلمة العربية "تَبَرّع" والتي تعكس مهمة قائمة على العطاء، والاستدامة، ورعاية المجتمع
              <br /><br />
              تتيح هذه المنصة للناس مشاركة الأغراض المستعملة بدلاً من التخلص منها
              مما يقلل من النفايات ويوفر الدعم لمن هم في حاجة
              من خلال إطالة دورة حياة المنتجات
               <br /><br />و تدعم مبادئ الحوسبة الخضراء بشكل فعّال  
              ...
              وتجنّب التبذير، والحفاظ على الأرض <br /><br />تَبرّع ليست مجرد منصة تبرع، بل هي حركة تجمع بين
      ...
      <section className="flex flex-col md:flex-row items-center bg-[#093965] p-10 mt-20 shadow-lg mb-10 gap-10">
        ...
        <div className="md:w-1/2">
          <h2 className="text-4xl font-bold text-[#10b981] mb-5 text-right ">
            بماذا يمكنك أن تتبرع؟
          </h2>
          <p className="text-lg text-white leading-loose whitespace-pre-line text-right">
