...
const ProfileInfo = ({ userInfo }) => {
  return (
    ...
    <div className="bg-white rounded-2xl shadow-xl p-8 transition-shadow duration-300 hover:shadow-2xl space-y-10">
      {/* Header */}
      <div className="flex items-center space-x-6">
        ...
        <div>
          <h1 className="text-3xl font-semibold text-gray-900">{userInfo.username}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[
          ...
          },
          {
            ...
            text: userInfo.phone_number || 'Not provided'
          },
          {
            label: "Location",
            icon: (
            ...
            text: userInfo.location || 'Not specified'
          },
          {
            label: "Rating",
            icon: (
            ...
            text: userInfo.rating !== undefined ? `${userInfo.rating} / 5` : 'No rating yet'
          },
          {
            label: "Active Posts",
            icon: (
            ...
            text: userInfo.active_posts !== undefined ? userInfo.active_posts : 0
          }
        ].map((item, index) => (
          <div
            key={index}
