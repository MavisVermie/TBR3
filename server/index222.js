...
//     // Query with specific columns and better error handling
//     const result = await pool.query(`
//       SELECT 
//         post_id,
//         title,
//         description,
//         primary_photo as attached_photo,
//         features,
//         location,
//         created_at,
//         user_id
...
//       ...post,
//       attached_photo: post.attached_photo ? post.attached_photo.toString('base64') : null,
//       features: post.features || ["Other"],
